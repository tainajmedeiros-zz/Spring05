...
//        );
//
//        Optional<Cliente> login = clienteRepository.findByLoginOrEmail(loginRequest.getLogin(), loginRequest.getLogin());
//
...
//        if(clienteRepository.existsByLogin(signUpRequest.getLogin())) {
...
//        Cliente user = new Cliente(signUpRequest.getLogin(), signUpRequest.getEmail(), signUpRequest.getPassword());
